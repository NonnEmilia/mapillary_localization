footer:
  getApp: "Scarica la App di Mapillary"
  on: "on"
  directAndroid: "Link diretto all file .apk per Android"
  manifesto: "Manifesto"
  about: "Informazioni"
  blog: "Blog"
  ...
  embed: "Utilizza"
  latestUploads: "Ultimi Upload"
  report: "Segnala Errori"
  follow: "Segui"
landing:
  more: "Altro"
  photos: "fotografie"
  meters: "metri"
landingBusiness:
  title: "Mapillary per uso Commerciale"
  use: "Usa le foto di Mapillary"
  service: "Accedi all'utilizzo commerciale delle API per usare le foto di Mapillary nei tuoi servizi."
  create: "Crea progetti, controlla gli accessi"
  private: "Gli utenti registrati possono creare progetti privati e controllare gli accessi per avere una versione completa e privata di Mapillary."
  integrate: "Utilizza le fotografie"
  gis: "Usa le nostre API o i nostri widget per inserire un visualizzatore Mapillary nella tua applicazione o nel tuo sistema GIS."
  learn: "Scopri di più sulle nostre offerte commerciali."
landingHow:
